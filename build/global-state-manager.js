...
exports.INVALID_NEW_GLOBAL_STATE = void 0;
...
var GlobalStateManager = (function () {
    ...
    GlobalStateManager.prototype.createDispatcher = function (reducer, name) {
        ...
        return function () {
            ...
            return _this.set(reducer.apply(void 0, __spreadArray([_this.state, _this.dispatcherMap], __read(args), false)), name, args)
    ...
    GlobalStateManager.prototype.getDispatcher = function (name) {
        ...
        throw new Error("Cannot return unknown ReactN reducer `".concat(name, "`."));
    };
    ...
    GlobalStateManager.prototype.spyState = function (propertyListener) {
        var _this = this;
        return (0, object_get_listener_1.default)(this._state, function (property) {
