...
function bindLifecycleMethods(that) {
    if (!(0, component_will_unmount_1.componentWillUnmountPrototype)(that)) {
    ...
    if (isUsingOldReact && !(0, component_will_update_1.componentWillUpdatePrototype)(that)) {
        that.componentWillUpdate = function () {
            (0, methods_1.ReactNComponentWillUpdate)(that);
        };
    }
    if (!isUsingOldReact && isPureComponent && !(0, component_will_update_1.componentWillUpdatePrototype)(that)) {
        that.UNSAFE_componentWillUpdate = function () {
            (0, methods_1.ReactNComponentWillUpdate)(that);
        };
    }
    if (!isUsingOldReact && !isPureComponent && !(0, should_component_update_1.shouldComponentUpdatePrototype)(that)) {
